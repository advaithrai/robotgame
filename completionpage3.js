...
test.completionpage3 = function(){};

test.completionpage3.prototype = {
     ...
     create: function() {
        ...
        var playButton1 = game.add.button(700,700, 'play', function() { game.state.start('storypage4'); health; gearCnt; ammo;})
