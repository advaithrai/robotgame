test.completionpage1 = function(){};

test.completionpage1.prototype = {
     ...
     create: function() {
        ...
        var playButton1 = game.add.button(700,700, 'play1', function() { game.state.start('levelthree'); health; gearCnt; ammo;})
